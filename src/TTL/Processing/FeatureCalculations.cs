...
namespace ProcessDashboard.src.TTL.Processing
{
    public static class FeatureCalculations
    {
        ...
        public static void Calculate(TTLProcess unit)
        {
            ...
            {
                Name = "t2",
                Description = "Time value of Heater turning ON",
            ...
            DataPoint t3 = new DataPoint()
            {
                ...
                Name = "t3",
                Description = "Time value of measured temperature equals the pre-defined set-value, TD. X: ps01_t3, Y: from Temperature",
            ...
            {
                Name = "t4",
                Description = "Time value of Heater turning OFF",
            ...
            DataPoint t7 = new DataPoint()
            {
                ...
                Name = "t7",
                Description = "Time of pressure intensifier released",
            ...
            DataPoint t9 = new DataPoint()
            {
                ...
                Name = "t9",
                Description = "Time value of measured temperature equals the pre-defined set-value",
            ...
            DataPoint t10 = new DataPoint()
            {
                ...
                Name = "t10",
                Description = "Time value of measured pressure equals the pre-defined pressure value, P1",
